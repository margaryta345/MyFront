...
const ConsoleLesson5 = () => {
  ...
  const runCode = async () => {
    ...
    try {
      axios
        .post(`/task5`, { requestData: sourseCode })
        .then((res) => {
          console.log(res);
  ...
  return (
    <div>
      <div className="lg:text-base  text-gray-600 items-center mt-6 mb-6 flex">
        ...
        <p className="ml-2">Задача класи,констуктори, методи </p>
      </div>
      <div className="flex">
        <div className="w-1/2">
...
class Transport:
        ...
        def __init__(self, speed, power, load_capacity):
...
class Car(Transport):
        ...
        def __init__(self, speed, power, load_capacity, brand):
