...
const ConsoleLesson3 = () => {
  ...
  const runCode = async () => {
    ...
    try {
      axios
        .post(`/task3`, { requestData: sourseCode })
        .then((res) => {
          console.log(res);
  ...
  return (
    <div>
      <div className="lg:text-base  text-gray-600 items-center mt-6 mb-6 flex">
        ...
        <p className="ml-2">Задача функції та рекурсія в Python</p>
      </div>
      <div className="flex">
        <div className="w-1/2">
          <div className="bg-[#252526] border border-gray-500">
            ...
            <Editor
              ...
              defaultValue={`def cube_volume_and_surface_area(side_length):
...
def find_compartment(seat_number):
